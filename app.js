...
function formatAndSendTweet(event) {
    ...
    const tweetText = `!BLIP #PunkBaby ${tokenName} bought for ${formattedPrice}${ethers.constants.EtherSymbol} @ https://opensea.io/activity/punkbabies #NFT #NFTs #PunkBabies`;
